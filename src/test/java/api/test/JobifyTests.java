...
public class JobifyTests {
	...
	public void testCreateJob(Method method,Map<String,Object> userPayload) {
		...
		Response response = RestUtils.performJsonPost(JobifyRoutes.createJobUrl, userPayload,token);
	...
	public void testGetSingleJob() {
		Response response = RestUtils.performJsonGet(JobifyRoutes.getSingleJobUrl,"id", id, token);
	}
	...
	public void testgetAllJobs(Method method,Map<String,Object> testData) {
		Response response = RestUtils.performJsonGet(JobifyRoutes.getALlJobsUrl, token);
	...
	public void testUpdateJob(Method method,Map<String,Object> testData) {
		Response response = RestUtils.performJsonPatch(JobifyRoutes.updateJobUrl,testData,"id", id,token);
	...
	public void testDeleteJob() {
		Response response = RestUtils.performJsonDelete(JobifyRoutes.getSingleJobUrl,"id", id, token);
	}
